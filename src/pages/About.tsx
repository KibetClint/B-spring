...
import leadEngineerImg from "@/assets/team/lead-engineer.jpg";
import salesManagerImg from "@/assets/team/sales-manager.jpg";
        ...
        <section className="gradient-hero py-20">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-3xl">
              <h1 className="text-primary-foreground mb-6">About Brickspring</h1>
              <p className="text-xl text-primary-foreground/90">
                Leading the industry in weighing solutions and technology services for over 15 years
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Founded in 2008, Brickspring has grown from a small weighing equipment supplier to a comprehensive 
                  technology solutions provider serving industries across East Africa and beyond.
                </p>
                <p className="text-muted-foreground mb-4">
                  Based in Litein, Kericho County, our journey has been driven by a commitment to innovation, quality, 
                  and customer satisfaction. We've continuously evolved our product and service offerings to meet the 
                  changing needs of modern businesses.
                </p>
                <p className="text-muted-foreground">
                  Today, we're proud to serve over 500 clients with our integrated solutions that combine 
                  hardware excellence, sophisticated software, cybersecurity, and expert professional services.
                </p>
              </div>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                The dedicated professionals driving innovation and excellence at Brickspring
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {teamMembers.map((member, index) => (
                <Card key={index} className="group overflow-hidden border-2 hover:border-accent transition-smooth hover:shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="border-2 hover:border-accent transition-smooth">
                <CardContent className="pt-8">
                  ...
                  <p className="text-muted-foreground">
                    To empower businesses with innovative weighing solutions and technology services 
                    that drive efficiency, accuracy, and growth.
                  </p>
                </CardContent>
              </Card>
              <Card className="border-2 hover:border-accent transition-smooth">
                <CardContent className="pt-8">
                  ...
                  <p className="text-muted-foreground">
                    To be the leading provider of integrated weighing and technology solutions in East Africa, 
                    recognized for innovation and customer excellence.
                  </p>
                </CardContent>
              </Card>
              <Card className="border-2 hover:border-accent transition-smooth">
                <CardContent className="pt-8">
                  ...
                  <p className="text-muted-foreground">
                    Quality, integrity, innovation, and customer satisfaction are at the core 
                    of everything we do.
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="py-20 bg-secondary/30">
          <div className="container mx-auto px-4 lg:px-8 text-center">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8">
              {["ISO 9001", "ISO 27001", "CE Certified", "Industry Partner"].map((cert, index) => (
